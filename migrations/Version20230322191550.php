 ...
 */
final class Version20230322191550 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE books (id INT NOT NULL, title VARCHAR(300) NOT NULL, date_of_publication DATE NOT NULL, PRIMARY KEY(id))');
